...
await run('solverIter=30', { solverIterations: 30 });
await run('solverIter=60', { solverIterations: 60 });
await run('solverIter=80', { solverIterations: 80 });
await run('solver50+damp0.1', { solverIterations: 50, damping: 0.1 });
await run('solver50+damp0.02', { solverIterations: 50, damping: 0.02 });
await run('solver50+unitStep1/120', { solverIterations: 50, unitStep: 1 / 120 });
await run('solver50+damp0.2', { solverIterations: 50, damping: 0.2 });
