...
await run('baseline (fix3)', {});
await run('solverIter=20', { solverIterations: 20 });
await run('solverIter=50', { solverIterations: 50 });
await run('solverIter=100', { solverIterations: 100 });
await run('warmup=120', { warmup: 120 });
await run('unitStep=1/120', { unitStep: 1 / 120 });
await run('unitStep=1/120 + solver20', { unitStep: 1 / 120, solverIterations: 20 });
await run('maxStepNum=6', { maxStepNum: 6 });
